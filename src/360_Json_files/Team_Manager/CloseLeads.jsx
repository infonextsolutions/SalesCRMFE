...
export const Sales_Close_Leads = {
      ...
      Pageslist: [
        {
          ...
          children: [
            ///FETCH DATA OF COLUMN
            {
              ...
              api: "API_ENDPOINTS[GET_SALES_CLOSE_LEADS]",
              data: {
                sortType: "desc",
                  ...
                  children: [
                    {
                      ...
                      editApi: "ALTER_SALES_CLOSE_LEADS_DATA",
                      deleteApi: "DELETE_SALES_CLOSE_LEADS_DATA",
                      getDataApi: "GET_SALES_CLOSE_LEADS",
                      approveApi: "APPROVE_SALES_CLOSE_LEADS_DATA",
                      endpoint: 'API_ENDPOINTS[GET_SALES_CLOSE_LEADS]',
                      dataPoint: "GET_SALES_CLOSE_LEADS",
