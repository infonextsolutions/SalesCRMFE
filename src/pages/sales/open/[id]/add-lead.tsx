  ...
  return (
    <div className="w-[100%] min-h-[90vh] pl-[40px] pr-[40px]">
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="contactName" type="text" placeholder="Contact Name"/>
            </div>
            <div className="mb-4">
