        ...
        <div className="bg-white shadow-lg rounded-3xl shadow-3xl flex w-3/4 max-w-5xl">
          <div className="w-3/5 p-3">
            ...
            <div className="flex flex-col items-center">
              <label
                htmlFor="username"
                className="block text-base mr-auto mb-2"
              >
                Username
              </label>
              <input
                type="text"
                id="username"
                className="border w-64 text-base px-2 py-2 focus:outline-none focus:ring-0 focus:border-gray-600"
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="py-1">
                  <div className="flex justify-between w-64 mb-5">
                    <label className="flex itemscenter text-xs">
                      <input
                        type={"checkbox"}
                        name={"remember"}
                        className="mr-1"
