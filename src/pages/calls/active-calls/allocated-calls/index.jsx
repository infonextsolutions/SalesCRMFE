...
<<<<<<< Updated upstream:src/pages/calls/active-calls/allocated-calls/index.tsx
      },
    };
...
>>>>>>> Stashed changes:src/pages/calls/active-calls/allocated-calls/index.jsx
        } else {
          return col;
        }
      });
                    ...
                    .then((res) => {
                        ...
                        setRows(data?.map((item, index) => {
                            let row = [
                                ...
                                { text: item?.qaId?.name || "-" },  // call review type
                                { text: item?.callId || "-" },  // call review status
                                { text: item?.qaClosedAt ? formatDateToCustomFormat(item?.qaClosedAt) : "-" },  // close date
