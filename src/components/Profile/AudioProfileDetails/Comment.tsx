...
const Comments = () => {
  return (
    ...
    <div className="py-2">
    <div className="bg-renal-blue rounded-xl items-center justify-center pl-[10px] mr-[50px] ml-[320px] pr-[10px] p-[10px]">
    <p className="whitespace-nowrap font-large text-[14px] pl-[10px] pr-[10px] text-[#ffffff] ">comment</p>
    </div>
    ...
    <h3 className="py-2 text-gray-500 text-small font-medium ml-7">Reply</h3>
    <div className="flex items-center justify-between mt-2 ml-4">
