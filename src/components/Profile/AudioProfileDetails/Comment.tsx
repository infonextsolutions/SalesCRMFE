...
const Comments = () => {
  return (
    ...
    className="w-[42%] ml-14 h-[110px] apperance-none bg-gray-50 text-gray-600 border rounded-xl py-4 px-3 focus:outline-none">
    </textarea>
    <div className="py-1 "></div>
    <button className="bg-renal-blue rounded-xl inline-block self-end py-2 ml-[360px] text-white pl-2 pr-2 px-4 text-sm">comment
    </button>
