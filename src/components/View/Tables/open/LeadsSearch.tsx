...
const LeadsTable = ({ totalRecords, search, queryStr }: TableProps) => {
  ...
  useEffect(function () {
    axios.get(
      `https://salescrmbe.onrender.com/api/leads/find-all?limit=${limit}&page=${pageNumber}&leadStatus=Open&${queryStr}`
    ).then(res => {
  ...
  const getallItems = async (current: any) => {
    const res = await axios.get(
      `https://salescrmbe.onrender.com/api/leads/find-all?limit=${limit}&page=${current}&leadStatus=Open&${queryStr}`
    );
  ...
  useEffect(() => {
    ...
    const getItems = async () => {
      const res = await axios.get(
        `https://salescrmbe.onrender.com/api/leads/find-all?leadStatus=Open&${queryStr}`
      );
